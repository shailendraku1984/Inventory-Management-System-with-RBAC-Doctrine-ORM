        ...
        <nav class="mt-2">
		    ...
		    <li class="nav-item <?= ($menuSelection['tabname'] === 'Settings') ? 'menu-open' : '' ?>">
              ...
              <li class="nav-item <?= ($menuSelection['tabname'] === 'INVENTORY') ? 'menu-open' : '' ?>">
				...
				<li class="nav-item <?= ($menuSelection['tabname'] === 'OTHERS') ? 'menu-open' : '' ?>">
					<a href="#" class="nav-link">
					  <i class="nav-icon bi bi-three-dots-vertical"></i>
					  <p>
						OTHERS
						<i class="nav-arrow bi bi-collection"></i>
					  </p>
					</a>
					<ul class="nav nav-treeview"> 
					 
					<li class="nav-item">
						<a href="<?= url_to('expenses.index') ?>" class="nav-link <?php echo ($menuSelection['action'] === 'expenses.index') ? 'active' : ''; ?>">
